...
public class DataPrinting {
	...
	public int findShortestTime1() {// Uses selection sort to sort the times.
		...
		return TimeListPlayer1.get(0);// Returns the first integer as the
										// shortest time taken.
	}
	...
	public int findShortestTime2() {// Uses selection sort to sort the times.
		...
		return TimeListPlayer2.get(0);// Returns the first integer as the
										// shortest time taken.
	}

	public void printTree() {
		BST bstObj1 = new BST(TimeListPlayer1.get(0));// Add the first as root
														// node
		...
		BST bstObj2 = new BST(TimeListPlayer1.get(0));// Add the first as root
														// node
